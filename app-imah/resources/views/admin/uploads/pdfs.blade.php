...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="card-title">Buscar PDFs</h5>
            <form action="{{ route('admin.pdfs') }}" method="GET">
                <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($uploads as $upload)
                            <tr>
                                <td>
                                    <a href="{{ asset('storage/uploads/pdf/' . $upload['nome_arquivo']) }}" target="_blank">Ver PDF</a>
                                </td>
                                ...
                                <td>
                                    <form action="{{ route('admin.upload.delete', ['tipo' => 'pdf', 'nomeArquivo' => $upload['nome_arquivo']]) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
