...
<head>
    ...
    <meta name="description" content="{{ $page->title }} - Pré-visualização IMAH">
    <meta name="keywords" content="máquinas industriais, IMAH, serigrafia">
    <meta property="og:title" content="{{ $page->title }} - Pré-visualização IMAH">
    <meta property="og:description" content="Pré-visualização de {{ $page->title }} da IMAH.">
    ...
    <title>{{ $page->title }} - Pré-visualização IMAH</title>
    <!-- Bootstrap CSS -->
